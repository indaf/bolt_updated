      ...
      <div className="bg-[#202123] rounded-lg p-8 max-w-md w-full">
        ...
        {status === 'success' && (
          <div className="text-center">
            ...
            <p className="text-gray-400 mb-6">Votre adresse email a été vérifiée avec succès.</p>
            <a
              href="/"
        ...
        {status === 'error' && (
          <div className="text-center">
            ...
            <h2 className="text-xl font-semibold text-white mb-2">Erreur de vérification</h2>
            <p className="text-gray-400 mb-6">Le lien de vérification est invalide ou a expiré.</p>
            <a
              href="/"
              className="inline-block px-4 py-2 bg-[#009B70] text-white rounded-lg hover:bg-[#007B56] transition-colors"
            >
